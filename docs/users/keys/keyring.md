...
MY_VALIDATOR_ADDRESS=$(fcod keys show dev0 -a)
```
...
yes $KEYPASSWD | fcod keys add me
yes $KEYPASSWD | fcod keys show me
# start fcod with keyring-backend flag
fcod --keyring-backend=file start
```

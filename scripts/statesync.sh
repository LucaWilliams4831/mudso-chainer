...
# Initialize chain.
fcod init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.fcod/config/

wget -O ~/.fcod/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
